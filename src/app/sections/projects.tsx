                ...
                <div className="w-full h-full mx-2">
                    ...
                    <BoxGrid>
                        {projectList.map((project, index) => (
                            <div
                                key={index}
                                className={`flex flex-col items-center bg-neutral-200 rounded-lg shadow-md p-4 h-150 dark:bg-neutral-800 border border-neutral-400 dark:border-neutral-600
                                    ${index === 0 ? "col-span-3" : ""}
